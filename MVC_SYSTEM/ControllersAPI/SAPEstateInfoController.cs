...
{
    public class SAPEstateInfoController : ApiController
    {
        ...
        public JsonResult<UploadResult> Post(CUSTOMITEM objData)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    sapPupConfig.SaveLog("SAPESTATEINFO", JsonConvert.SerializeObject(objData), estateInfo.fld_NegaraID, estateInfo.fld_SyarikatID, estateInfo.fld_WilayahID, estateInfo.fld_LadangID, "SAP", "Inbound");
            ...
            if (estateInfo != null)
            {
                sapPupConfig.SaveLog("SAPESTATEINFO", JsonConvert.SerializeObject(UploadResult), estateInfo.fld_NegaraID, estateInfo.fld_SyarikatID, estateInfo.fld_WilayahID, estateInfo.fld_LadangID, "SAP", "Outbound");
            }
