...
namespace MVC_SYSTEM.Controllers
{
    ...
    public class ApprovalController : Controller
    {
        ...
        public ActionResult Index(string ApprovalList)
        {
            ...
            GetNSWL.GetData(out NegaraID, out SyarikatID, out WilayahID, out LadangID, getuserid, User.Identity.Name);
            var approval = dbC.tblOptionConfigsWebs.Where(x => x.fldOptConfValue == ApprovalList &&  x.fldOptConfFlag1 == "approvallist" && x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fldDeleted == false).FirstOrDefault();
            return RedirectToAction(approval.fldOptConfValue, approval.fldOptConfFlag2);
        }
