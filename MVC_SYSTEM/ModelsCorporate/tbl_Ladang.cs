namespace MVC_SYSTEM.ModelsCorporate
{
    ...
    public partial class tbl_Ladang
    {
        ...
        [StringLength(5)]
        [Required(ErrorMessage = "Mandatory field. Data cannot be null.")] // add by wani 17.2.2021
        ...
        [StringLength(100)]
        [DataType(DataType.EmailAddress, ErrorMessage = "E-mail is not valid")] // add by wani 17.2.2021
        [Required(ErrorMessage = "Mandatory field. Data cannot be null.")] // add by wani 17.2.2021
